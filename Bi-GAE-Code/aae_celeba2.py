...
#     mmds = os.path.join(data_path,'aaes%d' % IMAGE_SIZE)
#     if not os.path.exists(os.path.join(data_path,'aaes%d' % IMAGE_SIZE)):
#         os.makedirs(os.path.join(data_path,'aaes%d' % IMAGE_SIZE))
#         print("目录创建成功！")
