...
class WALI(nn.Module):
    def __init__(self, E, G, C,rep_weights=[0.0,-1.0],mmd_g_scale=0.1,loss_type='msssim',sigma=[1,np.sqrt(2),2,np.sqrt(8),4],window_size=11,size_average=True,val_range=2,channel=3,l1=True,l2=False,pads=False,loss_type2=None):
    ...
    def forward(self, x, z, lamb=10,beta1=0.01,beta2=0.01,beta3=0.03,gan=0,loss_type='raw',var_beta=-1,clip_beta=-1,methods=0,l1=True,l2=False,val_range=2,normalize="relu",pads=False,ssm_alpha=0.84):
        ...
        if gan == 0:
            ...
            if self.loss_type == 'mse0':
                ...
                #
                # +RECON_Z_loss*beta2
                EG_loss2 = beta1*(mss_loss*beta3)+EG_loss
                # EG_loss2 = EG_loss2.mean()
                if l1 or l2:
                ...
                RECON_Z_loss = F.mse_loss(input=z_recon2, target=z, reduction='mean')
                # + RECON_Z_loss * beta2
                EG_loss2 = beta1 * (per_loss * beta3) + EG_loss
                # EG_loss2 = EG_loss2.mean()
        ...
        #         return C_loss, EG_loss, mmd_penalty
            ...
            if self.loss_type == 'mse0':
                ...
                EG_loss2 = beta1 * (mss_loss * beta3) + EG_loss
                if l1 or l2:
                    # RECON_Z_loss = RECON_Z_loss * z_recon_alpha
