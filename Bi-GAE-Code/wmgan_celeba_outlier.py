...
#
            ...
            if MMD_UPDATE:
                ...
                C_loss,EG_loss,RECON_Z_loss,EG_loss2,mmd_penalty = wali.forward(x=x,z=z,lamb=LAMBDA,beta1=1,beta2=0.12,gan=1,loss_type='mmd_b',methods=1,var_beta=var_beta,clip_beta=clip_beta)
                C_loss.backward()
                optimizerMox.step()
                # print("MMD update")
                MMD_iter += 1
...
#             # print training statistics
            if curr_iter % 10 == 0:
                ...
                print(
                    ...
                    % (curr_iter, ITER, EG_losses[-1], C_losses[-1],MMD_EG_losses[-1],MMD_C_losses[-1],Recon_z_losses[-1],mmd_penaltys[-1],
                       EG_losses2[-1]))
...
#
    ...
    np.save(mmds+"/%d/MMDEGloss_reg.npy" % num_exp,EG_losses2)
