...
def main():
    mmds = os.path.join(save_path, 'mmds-norm%d' % IMAGE_SIZE)
    if not os.path.exists(os.path.join(save_path, 'mmds-norm%d' % IMAGE_SIZE)):
        os.makedirs(os.path.join(save_path, 'mmds-norm%d' % IMAGE_SIZE))
        print("目录创建成功！")
