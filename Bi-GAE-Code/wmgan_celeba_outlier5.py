...
#
            ...
            if EG_update1:
                ...
                C_loss,EG_loss,mss_loss,l1_conv,mss_x_loss,EG_loss2,RECON_Z_loss = wali.forward(x=x,z=z,lamb=LAMBDA,gan=0,loss_type='msssim',beta1=1.5,beta2=0.25,beta3=0.8,methods=0,l1=True,val_range=2,normalize="relu", pads=False,ssm_alpha=0.84)
                # C_loss, EG_loss = wali.forward(x=x, z=z, lamb=LAMBDA, gan=0, loss_type='raw',methods=1,var_beta=var_beta,clip_beta=clip_beta)
                # EG_loss.backward()
                EG_loss2.backward()
                optimizerEG.step()
