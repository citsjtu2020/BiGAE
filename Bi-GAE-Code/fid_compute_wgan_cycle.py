...
# CUDA_VISIBLE_DEVICES=3 python fid_compute_wgan_cycle.py --num_exp=22 --low=18000 --high=20000 --image_size=256 --nlat=256
...
import wgan_base_celeba_dp512_load
...
def select_encoder(aim=10000, basedir=mmd_path_base0, modeldir=mmd_path0,cycle=False):
    ...
    if not os.path.exists(aim_file):
        aim_file = "total_%d.pth" % aim_epoch
        aim_file = os.path.join(modeldir, aim_file)
    return aim_file
...
def main(model="mmds", iteration=10000):
    ...
    wgan_path_base = "/data1/JCST/results/wgan512/celeba/21"
    wgan_path = "/data1/JCST/results/wgan512/21"

    biganqp_path = "/data1/JCST/results/biganqp256/22"
    biganqp_path_base = "/data1/JCST/results/biganqp256/celeba/22"
    bigan_path = "/data1/JCST/results/bigan256/22"
    bigan_path_base = "/data1/JCST/results/bigan256/celeba/22"
    aae_path = "/data1/JCST/results/aaes256/22"
    aae_path_base = "/data1/JCST/results/aaes256/celeba/22"
    # /data1/JCST/results/cycle256/22
    cycle_path = "/data1/JCST/results/cycle256/22"
    cycle_path_base = "/data1/JCST/results/cycle256/celeba/22"
    ...
    if "mmds" in model:
        ...
        network = wgan_base_celeba_dp512_load.create_WALI()
        network.to(device0)
        ...
        network = aae_celeba_outlier_dp19_load.create_WALI()
        network.to(device0)
        ...
        network = bigan_celeba_outlier_dp19_load.create_WALI()
        network.to(device0)
        ...
        network = biganqp_celeba_outlier_dp19_load.create_WALI()
        network.to(device0)
