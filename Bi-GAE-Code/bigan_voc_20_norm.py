...
def main():
    ...
    # if local_rank == 0:
    mmds = os.path.join(save_path,'bigan-norm%d' % IMAGE_SIZE)
    if not os.path.exists(os.path.join(save_path,'bigan-norm%d' % IMAGE_SIZE)):
        os.makedirs(os.path.join(save_path,'bigan-norm%d' % IMAGE_SIZE))
        print("目录创建成功！")
