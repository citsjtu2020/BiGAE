...
class WALI(nn.Module):
    def __init__(self, E, G, C,MMDX,MMDZ,rep_weights=[0.0,-1.0],mmd_g_scale=0.1,loss_type='msssim',sigma=[1,np.sqrt(2),2,np.sqrt(8),4],window_size=11,size_average=True,val_range=2,channel=3,l1=True,pads=False):
        ...
        if loss_type.strip() == 'msssim'.strip():
            msssim = MSSSIM(window_size=window_size, size_average=size_average, channel=3)
            self.sm = msssim
    ...
    def forward(self, x, z, lamb=10,beta1=0.01,beta2=0.01,beta3=0.03,gan=0,loss_type='raw',var_beta=-1,clip_beta=-1,methods=0,l1=True,val_range=2,normalize="relu",pads=False,ssm_alpha=0.84):
        ...
        if gan == 0:
            ...
            if self.loss_type == 'mse0':
                ...
                return C_loss,EG_loss,ssm_loss
                ...
                EG_loss2 = mss_loss*beta1+EG_loss
                if l1:
                    return C_loss,EG_loss,mss_loss,l1_conv,mss_x_loss,EG_loss2
                else:
            ...
            if self.loss_type == 'mmd':
                ...
                return C_loss,EG_loss,RECON_Z_loss,EG_loss2,mmd_penalty
                # C_loss,EG_loss =
